...
<?php
if ($_SESSION['admin_id'] != 22 && $_SESSION['admin_id'] != 23)
...
?>
			...
			<li><a href="changesettings.php" rel="dropmenu6_e" <?php echo authentication_groups_pemissions("Admin","menu","Y");?> >Admin</a></li> 
			<!-- bhavin end -->
