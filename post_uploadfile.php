...
if(isset($_REQUEST['do']) && ($_REQUEST['do'] == 'print') && !empty($_REQUEST['pid']) && isset($_REQUEST['pid']) ) {
	// echo("Insert Into tb_pending_print_req (cps_unique_req,cps_micr_code,cps_branchmicr_code,cps_account_no,cps_act_name,cps_no_of_books,cps_dly_bearer_order,cps_book_size,cps_tr_code,cps_atpar,cps_act_jointname1,cps_act_jointname2,cps_auth_sign1,cps_auth_sign2,cps_auth_sign3,cps_act_address1,cps_act_address2,cps_act_address3,cps_act_address4,cps_act_address5,cps_act_city,cps_state,cps_country,cps_emailid,cps_act_pin,cps_act_telephone_res,cps_act_telephone_off,cps_act_mobile,cps_ifsc_code,cps_chq_no_from,cps_chq_no_to,cps_micr_account_no,cps_date,cps_process_user_id,cps_bsr_code,cps_pr_code,cps_short_name,branch_sub_code) SELECT cps_unique_req,cps_micr_code,cps_branchmicr_code,cps_account_no,cps_act_name,cps_no_of_books,cps_dly_bearer_order,cps_book_size,cps_tr_code,cps_atpar,cps_act_jointname1,cps_act_jointname2,cps_auth_sign1,cps_auth_sign2,cps_auth_sign3,cps_act_address1,cps_act_address2,cps_act_address3,cps_act_address4,cps_act_address5,cps_act_city,cps_state,cps_country,cps_emailid,cps_act_pin,cps_act_telephone_res,cps_act_telephone_off,cps_act_mobile,cps_ifsc_code,cps_chq_no_from,cps_chq_no_to,cps_micr_account_no,cps_date,cps_process_user_id,cps_bsr_code,cps_pr_code,cps_short_name,branch_sub_code from tb_uploadingdata WHERE id IN (".$_REQUEST['pid'].")");
	// exit;
			...
			else
			{
				...
				{			
					...
					if($data->sheets[0]['cells'][$i][1] != "")
					{
						...
						$insertvalues =   '"'.$data->sheets[0]['cells'][$i][1].'","'.$data->sheets[0]['cells'][$i][2].'","'.$data->sheets[0]['cells'][$i][3].'","'.$data->sheets[0]['cells'][$i][4].'","'.$data->sheets[0]['cells'][$i][5].'","'.$data->sheets[0]['cells'][$i][6].'","'.$data->sheets[0]['cells'][$i][7].'","'.$data->sheets[0]['cells'][$i][8].'","'.$data->sheets[0]['cells'][$i][9].'","'.$data->sheets[0]['cells'][$i][10].'","'.$data->sheets[0]['cells'][$i][11].'","'.$data->sheets[0]['cells'][$i][12].'","'.$data->sheets[0]['cells'][$i][13].'","'.$data->sheets[0]['cells'][$i][14].'","'.$data->sheets[0]['cells'][$i][15].'","'.$data->sheets[0]['cells'][$i][16].'","'.$data->sheets[0]['cells'][$i][17].'","'.str_pad($data->sheets[0]['cells'][$i][18], 3, "0", STR_PAD_LEFT).str_pad($data->sheets[0]['cells'][$i][19], 3, "0", STR_PAD_LEFT).str_pad($branchCode, 3, "0", STR_PAD_LEFT).'","'.$data->sheets[0]['cells'][$i][21].'","'.substr(str_pad($data->sheets[0]['cells'][$i][23], 3, "0", STR_PAD_LEFT),-6).'","'.$data->sheets[0]['cells'][$i][23].'","'.$data->sheets[0]['cells'][$i][24].'","'.$data->sheets[0]['cells'][$i][25].'","'.$data->sheets[0]['cells'][$i][26].'","'.$data->sheets[0]['cells'][$i][27].'","'.$data->sheets[0]['cells'][$i][28].'","'.$data->sheets[0]['cells'][$i][29].'","'.$data->sheets[0]['cells'][$i][30].'","'.$data->sheets[0]['cells'][$i][31].'","'.date("Y-m-d").'","'.$_SESSION["admin_id"].'","'.$data->sheets[0]['cells'][$i][20].'","'.$data->sheets[0]['cells'][$i][33].'""'.$data->sheets[0]['cells'][$i][36].'"';
...
/*
	...
	exit;
 */
	// where cps_branchmicr_code = '".$_REQUEST['ddlBranchName']."'
